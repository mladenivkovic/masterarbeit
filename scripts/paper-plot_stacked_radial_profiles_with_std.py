...
#==========================================
    ...
    fitalpha = 1.0
    nonorphanalpha = 0.35
    nonorphanlabel = "without orphan galaxies"
    ...
    #  for sim, srcdir in enumerate(["galaxy-512-new-cosmo-100MPC", "galaxy-512-new-cosmo-69MPC"]):
        ...
        if plot_paper_values:
            ...
            ax1.loglog(
                ...
                "--", 
                c = 'b',
                label="vdB+15 "+r"$10^9 M_\odot < M_* < 10^{10} M_\odot$",
                alpha = 0.8,
                lw=1,
                )
            c_paper2 = 2.31
            ...
            ax1.loglog(
                ...
                "--", 
                c = 'k', 
                label="vdB+15 "+r"$M_* > 10^{10} M_\odot$",
                alpha = 0.8,
                lw=1,
                )
        ...
        for i, t in enumerate(thresholds):
            ...
            if sim == 0 and (i == len(thresholds) - 1):
                nl = nonorphanlabel
            else:
                nl = None
    ...
    # save image
    fname = "paper-radial-profiles-stacked-std-"+outputnr+".pdf"
    plt.tight_layout()
    #  plt.show()
