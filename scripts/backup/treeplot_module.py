...
-------------
     ...
     flags.
     for a purely aesthetical image, use --no-labels --no-colors --tex flags.
...
images inside the directory. (Analoguely if you chose the --tex or --pdf flags)
...
#======================
    ...
    #========================
        ...
        print "last directory:", self.lastdir, "(I'll figure out later whether this is the z=0 directory)"
        if self.start > 0:
            print "You've given starting snapshot number", self.start
        ...
        print "Clumps in tree plot will be labelled?", self.treeclumplabels
        ...
        if self.tex:
            ...
            form = 'png'
        print "image will be saved as a", form, "file"
...
#===========================================================
def _draw_tree(node, ax, colorlist, plot_labels, strategy):
#===========================================================
    """
...
#==============================================================
def _draw_straight_lines(x_values, ax, params, strategy):
#==============================================================
    """
    ...
    for x in x_values:
        ...
        inner, outer = _get_plotcolors(x.x, colorlist)
...
#============================================================
def _draw_tree_on_plot(node, prog, ax, colorlist, strategy):
#============================================================
    """
...
#====================================================
def _draw_tree_labels(node, ax, colorlist, strategy):
#====================================================
    """
...
#======================================================================================
def make_tree(progenitors, descendants, progenitor_outputnrs, outputnrs, t, params):
#======================================================================================
    """
    ...
    for out in range(startind,nout_present): 
        for i in range(progenitors[out].shape[0]):
            if progenitors[out][i] < 0 : # found a jumper
                ...
                out2 = out
                reached_end = (out2 == startind) # don't check if you're at root
    ...
    for i in range(startind, nout_present+1):
        tree.append([])
...
#============================================================================
    ...
    _save_fig(fig, params, plotparticles=True)
...
#=======================================================
    ...
    # draw the tree
    _draw_straight_lines(x_values, ax, params, strategy)
    _draw_tree(tree[0][0], ax, params.colorlist, params.treeclumplabels, strategy)

    # Tweak the plot
    _tweak_treeplot(fig, yaxis_int[:len(tree)+1], yaxis_phys[:len(tree)+1], borders, params)
    
    # Save the figure
    _save_fig(fig, params, strategy)
...
#====================================================================
def _save_fig(fig, params, strategy="default", plotparticles=False):
#====================================================================
    """
    Save figure as png.
